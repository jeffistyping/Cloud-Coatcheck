...
script_path = os.path.abspath(os.path.join(os.getcwd(), 'check.py'))

check_stock = "python -u %s" % script_path
...
test_executor = Executor(topic=TOPIC, project=PROJECT, task_cmd=check_stock, subname='sample_task_task')
